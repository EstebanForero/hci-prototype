/**
 * Cotton Detection Modal Component
...
interface CottonDetectionModalProps {
  isOpen: boolean;
  washProgram: any;
  onConfirm: () => void;
  onCancel: () => void;
...
export function CottonDetectionModal({ isOpen, washProgram, onConfirm, onCancel }: CottonDetectionModalProps) {
  ...
  return createPortal(
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="bg-gradient-to-br from-green-500/20 to-blue-500/20 backdrop-blur-md border border-green-500/30 rounded-2xl p-6 shadow-2xl">
            {/* Header with icon */}
            ...
            <div className="bg-black/30 rounded-xl p-5 mb-6 border border-white/10">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-2 border-b border-white/10">
                  ...
                  <span className="text-white font-medium capitalize">{washProgram.config.cycle}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-white/10">
                  <span className="text-gray-400 text-sm flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex space-x-3">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={onConfirm}
                className="flex-1 px-4 py-3 bg-gradient-to-r from-green-500/20 to-blue-500/20 hover:from-green-500/30 hover:to-blue-500/30 text-green-400 rounded-xl transition-colors border border-green-500/30 font-medium"
              >
                Start Wash
              </motion.button>
            </div>
